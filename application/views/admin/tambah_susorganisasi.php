                ...
                <div class="container-fluid">
                    ...
                    <?= form_open_multipart('core/susorganisasi/simpan'); ?>
                    <div class="row">
                        <div class="form-group col-md-9">
                            <div class="card shadow pb-2 col-md-12">
                                <label class="mt-1 text-dark" for="isi_susunan"><b>Susunan Pengurus<b
                                            class="text-danger">*</b></b></label>
                                <textarea name="isi_susunan" id="isi_susunan" class="form-control ckeditor" cols="30" rows="10"
                                    required></textarea>
                            </div>
                        </div>
                    </div>
